...
async function main() {
  ...
  // Create activity logs for multi-reviewer activities
    ...
    data: [
      {
        ...
        details: "Assigned 3 reviewers for Stage 0 gate review",
        metadata: {
          reviewerIds: [reviewer1.id, reviewer2.id, gatekeeper1.id],
          stage: "STAGE_0",
        },
      },
      {
        ...
        details: "Completed Stage 0 review with GO decision",
        metadata: {
          stage: "STAGE_0",
          decision: "GO",
          score: 4.2,
      ...
      },
      {
        ...
        projectId: project4.id,
        action: "REVIEWERS_ASSIGNED",
        details: "Assigned 3 reviewers for Stage 1 gate review",
        metadata: {
          reviewerIds: [reviewer1.id, reviewer2.id, gatekeeper1.id],
          stage: "STAGE_1",
        },
  ...
  await prisma.notification.createMany({
    data: [
      ...
      },
      {
        ...
        message:
          "You have been assigned to review Urban Traffic Flow AI for Stage 1",
        isRead: false,
        data: {
          projectId: project4.id,
          stage: "STAGE_1",
  ...
  await (prisma as any).notificationPreference.createMany({
    data: [
      {
        userId: adminUser.id,
  ...
  await prisma.template.createMany({
    data: [
      {
        name: "Stage 0 Business Case Template",
        description: "Standard template for Stage 0 business case documents",
        type: "BUSINESS_CASE",
        stage: "STAGE_0",
        fileUrl:
          "https://sharepoint.csir.co.za/sites/templates/stage0-business-case.docx",
        fileName: "stage0-business-case-template.docx",
        isActive: true,
      },
      {
        name: "Technical Specification Template",
        description: "Template for detailed technical specifications",
        type: "TECHNICAL_SPEC",
        stage: "STAGE_1",
        fileUrl:
          "https://sharepoint.csir.co.za/sites/templates/technical-specs.docx",
        fileName: "technical-specs-template.docx",
        isActive: true,
      },
      {
        name: "Risk Assessment Template",
        description: "Template for project risk assessment documents",
        type: "RISK_ASSESSMENT",
        stage: "STAGE_1",
        fileUrl:
          "https://sharepoint.csir.co.za/sites/templates/risk-assessment.xlsx",
